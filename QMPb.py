...
def continuing_criterium_2(x, s, c, tolerance, L_thresh):
...
def MP_2(s, D, tolerance, error_type="", L_thresh=0, info='', error=0):
    N, M = D.shape
    ...
    # initialization of fixed parameters for exit condition
